  ...
  projects: Card[] = [
    {
      id: 1,
      name: 'Schoyo',
      summary: 'This is a Erp-Software developed using HTML, CSS, Angular, Java, and MYSQL.',
      description: 'Schoyo is a pioneering software solution designed with a concerted focus on the evolving needs of students and other direct & indirect users of the EdTech domain like parents, faculty, institutes etc. Schoyo aims to revolutionize this user segment by providing several new and some refashioned old features like news and articles, career guidance etc.',
      projectLink: 'test.schoyo.com',
      tags: [Tag.JAVA, Tag.HTML5, Tag.CSS3, Tag.SQL, Tag.SPRINGBOOT, Tag.DOCKER,],
